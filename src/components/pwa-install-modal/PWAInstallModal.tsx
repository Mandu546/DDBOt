...
const PWAInstallModal: React.FC = () => {
    ...
    const getInstallSteps = () => {
        if (isDesktop) {
            return [
                ...
                localize('Follow the prompts to install Dopra Bot.'),
            ];
        } else if (isIOS) {
            return [
                localize('Open Dopra Bot in your browser.'),
        ...
        <div className='pwa-install-modal__content'>
            <div className='pwa-install-modal__description'>
                <Text size='xs' color='prominent'>
                    {isPWALaunch
                        ? localize("Welcome to Dopra Bot! You're using the mobile app version.")
                        : isDesktop
                          ? localize('Install Dopra Bot as a desktop app for faster access and a native experience!')
                          : localize(
                                "We're excited to announce that Dopra Bot platform is now a Progressive Web App (PWA)!"
                            )}
                </Text>
            </div>
    ...
    const modalContent = isMobile ? (
        <MobileFullPageModal
            ...
            page_header_text={localize('Install Dopra Bot')}
        ...
        <Modal
            ...
            title={isDesktop ? localize('Install Dopra Bot') : localize('Introducing our installable app')}
            has_close_icon={true}
