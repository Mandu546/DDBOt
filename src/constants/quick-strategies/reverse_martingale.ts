...
export const REVERSE_MARTINGALE = (): TDescriptionItem[] => [
    {
        type: 'subtitle',
        content: [localize('Exploring the Reverse Martingale strategy in Dopra Bot')],
        expanded: true,
    ...
    {
        type: 'text',
        content: [localize('These are the trade parameters used in Dopra Bot with Reverse Martingale strategy.')],
    },
    {
        type: 'text',
        content: [
    ...
    },
    {
        ...
        content: [
            ...
            localize(
                '3. If the first trade is a successful trade, Dopra Bot will automatically double your stake for the next trade to 2 USD. Dopra Bot will continue to double the stake after every successful trade.'
            ),
            localize(
