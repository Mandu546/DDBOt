...
export default class AppStore {
    ...
    getErrorForNonEuClients = () => ({
        ...
        title: localize('Dopra Bot is unavailable for this account'),
    ...
    getErrorForEuClients = (is_logged_in = false, country: string | undefined = undefined) => {
        return {
            text: ' ',
            title: is_logged_in
                ? localize(`Dopra Bot is not available for ${country || 'EU'} clients`)
                : localize(`Dopra Bot is unavailable in ${country || 'the EU'}`),
